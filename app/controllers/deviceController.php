...
class deviceController extends mainModel
{
    ...
    public function addDeviceController(){
        ...
        FROM devices WHERE device_isDelivered = 1");
    ...
    public function deviceListController($page, $register, $url, $search){
        ...
        OR device_withdrawalUser LIKE '%$search%' 
        ORDER BY device_ID 
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                            <thead class="text-base text-white uppercase bg-gray-800">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3">Descripcion del Articulo</th>
                                    <th scope="col" class="px-6 py-3">Entregago por</th>
            ...
            foreach ($data as $rows) {
                $table .= '
                    <tr class="bg-white border-b hover:bg-gray-200">
                        ...
                        <a href="' . APPURL . 'deviceDescription/' . $rows['device_ID'] . '/" class="bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-base p-2.5 text-center inline-flex items-center me-2">
                        ...
                        <td class="px-6 py-3 text-center">
                            <div class="flex justify-center items-center">
                                <a href="#" class="bg-green-500 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300  rounded-full text-base p-2.5 text-center inline-flex items-center me-2">
                                <svg class="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H8m12 0-4 4m4-4-4-4M9 4H7a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h2" />
                                </svg>
                            </a>
                            <a href="' . APPURL . 'updateDevices/' . $rows['device_ID'] . '/" class="bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-full text-base p-2.5 text-center inline-flex items-center me-2">
                                <svg class="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
