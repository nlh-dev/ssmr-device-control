            ...
            foreach ($data as $rows) {
                $table .= '
                    <tr class="bg-white border-b hover:bg-gray-200">
                        ...
                        <td class="px-6 py-3">' . $rows['observation_reason'] . '</td>
                        <td class="px-6 py-3">' . $rows['observation_text'] . '</td>
                        <td class="px-6 py-3">' . $rows['observation_creationDate'] . '</td>
                        <td class="px-6 py-3 text-center">
                            <div class="flex justify-center items-center">
                            <a href="' . APPURL . 'viewObservation/' . $rows['observation_ID'] . '/" class="bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-full text-base p-2.5 text-center inline-flex items-center me-2">
                            ...
                            <form class="AjaxForm" action="' . APPURL . 'app/ajax/deviceAjax.php" method="POST">
                                ...
                                <input type="hidden" name="user_ID" value="' . $rows['observation_ID'] . '">
