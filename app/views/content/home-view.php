        ...
        <div class="grid sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
            <div class="p-6 bg-gray-800 rounded-lg hover:bg-gray-900 transition duration-100">
                <a href="<?= APPURL ?>devicePanel/">
                    ...
                    <p class="font-bold text-gray-200">Ver control de entregas </p>
                </a>
            </div>
            ...
            <div class="p-6 bg-gray-800 rounded-lg hover:bg-gray-900  transition duration-100">
                <a href="<?= APPURL ?>deviceStorage/">
                    ...
                    <p class="font-bold text-gray-200">Ver entregas previas</p>
                </a>
            </div>
            ...
            <div>
                <div class="my-5">
                    ...
                    <nav class="flex" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            <li class="inline-flex items-center">
                                <a href="#" class="inline-flex items-center text-lg font-medium text-gray-700 hover:text-blue-600">
                ...
                <div class="grid sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 mt-3">
                    ...
                    <div class="p-6 bg-gray-800 rounded-lg hover:bg-gray-900 transition duration-100">
                        <a href="<?= APPURL ?>departments/">
                            ...
                            <p class="font-bold text-gray-200">Ver lista de departamentos</p>
                        </a>
                    </div>
                <?php } ?>
                <!-- OPTION ENDS -->
