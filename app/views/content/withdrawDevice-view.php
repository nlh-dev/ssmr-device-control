            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#" class="ms-1 text-lg font-medium text-gray-700 hover:text-blue-600 md:ms-2">Retiro</a>
                    </div>
                </li>
            </ol>
        </nav>
                ...
                <div class="grid mb-6 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
                    <div>
                        ...
                        <div class="relative mb-3">
                            ...
                            <input type="text" id="userWithdraw" name="userWithdraw" class="bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 cursor-not-allowed" placeholder="Usuario...." value="<?= $_SESSION['firstName'] ?> <?= $_SESSION['lastName'] ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="withdrawDate" name="withdrawDate" datepicker datepicker-autohide datepicker-buttons datepicker-autoselect-today type="text" class="bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="Selecionar Fecha...." datepicker-format="dd/mm/yyyy" value="">
                        </div>
                    </div>
                </div>
