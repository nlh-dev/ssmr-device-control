            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#" class="ms-1 text-lg font-medium text-gray-700 hover:text-blue-600 md:ms-2">Editar Observación</a>
                    </div>
                </li>
            </ol>
        </nav>
            ...
            <form action="<?= APPURL ?>app/ajax/observationsAjax.php" class="AjaxForm" method="POST" autocomplete="off">
                ...
                <div class="grid mb-4 sm:grid-cols-1 lg:grid-cols-1 gap-3">
                    <div class="grid sm:grid-cols-2 lg:grid-cols-2 gap-3">
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900">Creada por: </label>
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900">Fecha de Creación</label>
                            <div class="relative">
                                ...
                                <input id="observationDate" name="observationDate" datepicker datepicker-buttons datepicker-autoselect-today type="text" class="bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="Selecionar Fecha...." datepicker-format="dd-mm-yyyy" value="<?= $observationData['observation_creationDate'] ?>">
                            </div>
                        </div>
                    </div>
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900">Motivo</label>
                        <div class="relative mb-3">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                                <svg class="w-5 h-5 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <div class="w-full mb-4 border border-gray-300 rounded-lg bg-gray-50">
                        <div class="px-4 py-2 bg-white rounded-t-lg">
                            <textarea id="observationText" name="observationText" rows="5" class="w-full px-0 text-sm text-gray-900 bg-white border-0" placeholder="Redactar Observación...."><?= $observationData['observation_text'] ?></textarea>
                        </div>
