<div class="flex-grow p-4 sm:ml-64">
    <div class="p-4 mt-14">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="<?= APPURL ?>controlStorage/" class="ms-1 text-lg font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Entregas Previas</a>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <!-- <form action="<?= APPURL ?>app/ajax/deviceAjax.php" class="AjaxForm" method="POST">
            <div class="flex items-center max-w-sm ml-auto my-4">
                ...
                <div class="relative w-full">
                    ...
                    <input type="text" id="departmentName" name="departmentName" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Buscar Registro..." />
                </div>
                <button type="submit" class="p-2.5 ms-2 text-sm font-medium text-white bg-gray-800 rounded-lg border border-gray-700 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300">
        ...
        echo $instanceDevice->withdrawDeviceListController($url[1], 10, $url[0], "");
