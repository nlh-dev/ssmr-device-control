<div class="p-4 sm:ml-64">
    <div class="p-4 mt-14">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#" class="ms-1 text-lg font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Ver</a>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        if ($deviceData->rowCount() == 1) {$deviceData = $deviceData->fetch(); ?>
            ...
            <div class="grid mb-6 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
                ...
                <div>
                    ...
                    <?php if ($deviceData['device_isDelivered'] != true) {
                        echo "Dispositivo Retirado";
                    } else {
                        echo "Dispositivo Entregado";
                    }?>
                </div>
            </div>
