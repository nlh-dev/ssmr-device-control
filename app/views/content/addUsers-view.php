            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="<?= APPURL ?>users/" class="ms-1 text-lg font-medium text-gray-700 hover:text-blue-600 md:ms-2">Usuarios</a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#" class="ms-1 text-lg font-medium text-gray-700 hover:text-blue-600 md:ms-2">Añadir Usuario</a>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <form action="<?= APPURL ?>app/ajax/userAjax.php" class="AjaxForm" method="POST" autocomplete="off">
            ...
            <div class="mb-4 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <h1 class="text-strong text-xl font-bold text-gray-800">Información de Usuario</h1>
                </div>
                <div>
            ...
            <div class="grid mb-4 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-3">
                <div>
                    ...
                    <div class="relative mb-3">
                        ...
                        <input type="text" id="firstName" name="firstName" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.55" placeholder="Inserte Nombre....">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative mb-6">
                        ...
                        <input type="text" id="lastName" name="lastName" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.55" placeholder="Inserte Apellido....">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative mb-6">
                        ...
                        <input type="text" id="userName" name="userName" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.55" placeholder="Inserte Nombre de Usuario....">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative mb-6">
                        ...
                        <input type="password" id="userPassword" name="userPassword" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="Inserte Contraseña....">
                    </div>
                </div>
                <div>
                    <label for="countries" class="block mb-2 text-sm font-medium text-gray-900">Rol de Usuario</label>
