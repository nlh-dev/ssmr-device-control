            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#" class="ms-1 text-lg font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Añadir Observación</a>
                    </div>
                </li>
            </ol>
        </nav>
            ...
            <div>
                ...
                <div class="w-full mb-4 border border-gray-300 rounded-lg bg-gray-50">
                    <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
                        <textarea id="observationText" name="observationText" rows="5" class="w-full px-0 text-sm text-gray-900 bg-white border-0 dark:bg-gray-800" placeholder="Redactar Observación...."></textarea>
                    </div>
