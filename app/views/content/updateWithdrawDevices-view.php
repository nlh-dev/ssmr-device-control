<div class="p-4 sm:ml-64">
    <div class="p-4 mt-14">
        ...
        <form action="<?= APPURL?>app/ajax/deviceAjax.php" class="AjaxForm" method="POST" autocomplete="off">
            ...
            <input type="hidden" name="deviceModule" id="deviceModule" value="updateDevice">
            ...
            <div class="grid mb-6 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
                <div>
                    ...
                    <div class="relative mb-3">
                        ...
                        <input type="text" id="userDeliver" name="userDeliver" class="bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  cursor-not-allowed" placeholder="Usuario...." value="<?= $deviceData['device_userFullName']?>" readonly>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative mb-3">
                        ...
                        <input type="text" id="recievedByName" name="recievedByName" class="bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 " placeholder="Inserte Receptor del Artículo...." value="<?= $deviceData['device_recievedByName']?>">
                    </div>
                </div>
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="deliveryDate" name="deliveryDate" datepicker datepicker-autohide datepicker-buttons datepicker-autoselect-today type="text" class="bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 " placeholder="Selecionar Fecha...." datepicker-format="dd/mm/yyyy" value="<?= $deviceData['device_deliveryDate']?>">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative mb-3">
                        ...
                        <input type="text" id="itemDescription" name="itemDescription" class="bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 " placeholder="Inserte Descripcion...." value="<?= $deviceData['device_Description']?>">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative mb-3">
                        ...
                        <input type="text" id="itemCode" name="itemCode" class="bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 " placeholder="Inserte Serial...." value="<?= $deviceData['device_serialCode']?>">
                    </div>
                </div>
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-900">Departamento</label>
                    <div class="relative mb-3">
                        <select id="departmentName" name="departmentName" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                ...
                <div>
                    ...
                    <div class="relative mb-3">
                        ...
                        <input type="text" id="roomCode" name="roomCode" class="bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 " placeholder="Inserte Código de Habitación...." value="<?= $deviceData['device_RoomCode']?>">
                    </div>
                </div>
            </div>
