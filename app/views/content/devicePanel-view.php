<div class="flex-grow p-4 sm:ml-64">
    <div class="p-4 mt-14">
        ...
        <div class="w-full flex justify-end items-center my-4">
            <a href="<?= APPURL ?>addDevice/" class="block text-white bg-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="button">
        ...
        echo $instanceDevice->deviceListController($url[1], 5, $url[0], "");
