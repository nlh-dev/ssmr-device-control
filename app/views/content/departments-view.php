            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="<?= APPURL ?>departments/" class="ms-1 text-lg font-medium text-gray-700 hover:text-blue-600 md:ms-2">Departamentos</a>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <form action="<?= APPURL ?>app/ajax/departmentsAjax.php" class="AjaxForm" method="POST">
            <div class="flex items-center max-w-sm ml-auto my-4">
                ...
                <div class="relative w-full">
                    ...
                    <input type="text" id="departmentName" name="departmentName" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="Añadir Departamento..." />
                </div>
