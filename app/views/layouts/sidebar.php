                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-sm shadow-sm dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user">
                        ...
                        <ul class="py-1 px-2" role="none">
                            <div class="border-t border-gray-500">
                                <li class="mt-2">
                                    <a href="<?= APPURL ?>updateUsers/<?= $_SESSION['ID'] ?>/" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-700 hover:text-white rounded-lg transition duration-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white">Perfil</a>
                                </li>
                                <li class="mb-2">
                                    <a href="<?= APPURL ?>logout/" id="logoutButton" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-700 hover:text-white rounded-lg transition duration-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white">
                                        Cerrar Sesión
                                    </a>
                                </li>
                            </div>
...
<!-- SIDEBAR -->
<aside id="logo-sidebar" class="fixed left-0 top-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-gray-900 border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
