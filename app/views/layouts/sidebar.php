...
<aside id="logo-sidebar" class="fixed left-0 top-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-gray-900 border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-gray-900 dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <div class="mb-3">
                    <a href="<?= APPURL ?>observations/" class="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                        <svg class="w-7 h-7 text-gray-500 transition duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <?php if ($_SESSION['role'] == 1) { ?>
                <li>
                    ...
                    <div class="mt-2">
                        <a href="<?= APPURL ?>departments/" class="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                            <svg class="w-7 h-7 text-gray-500 transition duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
